...
export const PrivacyPolicyComponent = () => {
  return (
    <ShowcaseBanner
      ...
      description="Policies in this section would help you better understand how we collect, use, store and share your information."
      descriptionClassName="!normal-case !text-[16.9px] !max-w-[18rem] md:!leading-[30px]  md:!max-w-[27rem] md:!text-[18px] !mt-9 md:!mt-5 !tracking-tighter !text-gray-primary/45"
    />
  );
};
