...
import { aboutUsShowcaseImg, market1 } from "@/constant/imgs";
    ...
    <div className="relative">
      ...
      >
        <section className="md:max-w-[70.6rem] text-center flex flex-col items-center font-sans pt-[4.8rem] mx-auto max-w-lg">
          {aboutText && (
            <Fade>
              <h2 className="px-3 py-1 text-primary border-gray-300 border rounded-md shadow-md">
                {aboutText}
              </h2>
            </Fade>
          )}
                  ...
                  <div className={`max-w-[980px] md:mx-auto`}>
                    <video className="h-full w-full !rounded-2xl px-6" controls>
                      <source
                        src={`${
                          translate === "en"
                            ? "https://res.cloudinary.com/mobinet/video/upload/v1711544369/english_version_zk2fex.mp4"
                            : "https://res.cloudinary.com/mobinet/video/upload/v1711598651/TrainingVideo_Japanesse_wdvc6j.mp4"
                        }`}
                        type="video/mp4"
                      />
      ...
      {aboutUsImg ? (
        <>
          ...
          <div className="md:hidden !z-50 md:-mt-[449px] -mt-[368px]  absolute">
            <Image
              src={market1}
              // className="h-40"
              alt={"about showcase image"}
