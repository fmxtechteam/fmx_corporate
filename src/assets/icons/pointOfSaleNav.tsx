export const pointOfSaleNav = ({ className }: { className?: string }) => {
  return (
    <svg
      width={78}
      height={78}
      ...
      className={className}
    >
      <g filter="url(#filter0_d_479_1153)">
      ...
      <defs>
        ...
        >
          ...
          <feBlend
            ...
            result="effect1_dropShadow_479_1153"
          />
          <feBlend
            mode="normal"
            in="SourceGraphic"
            in2="effect1_dropShadow_479_1153"
            result="shape"
          />
        </filter>
      </defs>
