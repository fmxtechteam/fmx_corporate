export const SupplyChain = ({ className }: { className?: string }) => {
  return (
    <svg
      width={78}
      height={78}
      ...
      className={className}
    >
      <g filter="url(#filter0_d_322_128)">
      ...
      <defs>
        ...
        >
          ...
          <feBlend
            ...
            result="effect1_dropShadow_322_128"
          />
          <feBlend
            mode="normal"
            in="SourceGraphic"
            in2="effect1_dropShadow_322_128"
            result="shape"
          />
        </filter>
      </defs>
